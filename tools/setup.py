...
def main():
    ...
    print("""
  ######################################
  # RRSF Development Environment Setup #
  ######################################

  This script will create your RRSF dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your RRSF project folder:
    [Arma 3 installation directory]\\{} => RRSF project folder
    P:\\{}                              => RRSF project folder
